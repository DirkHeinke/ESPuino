	...
	*/
	// *****BUTTON*****        *****ACTION*****
	#define BUTTON_0_SHORT    CMD_NOTHING //CMD_NEXTTRACK
	#define BUTTON_1_SHORT    CMD_NOTHING //CMD_PREVTRACK
	...
	#define BUTTON_0_LONG     CMD_NOTHING //CMD_LASTTRACK
	#define BUTTON_1_LONG     CMD_NOTHING //CMD_FIRSTTRACK
	#define BUTTON_2_LONG     CMD_NOTHING //CMD_PLAYPAUSE
